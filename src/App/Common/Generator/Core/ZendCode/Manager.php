...
(new PropertyGenerator('wasInTransaction',false,PropertyGenerator::FLAG_PROTECTED
                ))->setDocBlock((new DocBlockGenerator())
            ->setShortDescription('True if we were already in a transaction when try to start a new one')
            ->setLongDescription('')
            ->setTags([
...
,                    
            ...
            ->setTags([
                ...
                [
                    'name'       => 'getResult',
                    'parameters' => [
                        new ParameterGenerator('columns',
                            'array'),
                        new ParameterGenerator('join',
                            'array',
                            []),
                        new ParameterGenerator('where',
                            'array',
                            []),
                        new ParameterGenerator('orderBy',
                            'array',
                            []),
                        new ParameterGenerator('groupBy',
                            'array',
                            []),
                        new ParameterGenerator('having',
                            'array',
                            []),
                        new ParameterGenerator('limit',
                            'int',
                            null),
                        new ParameterGenerator('offset',
                            'int',
...
BODY
                    ...
                    'docblock'   =>
                    (new DocBlockGenerator())
            ->setShortDescription('Manage params of sql request and return results')
            ->setLongDescription('')
            ->setTags([
...
,
                    'docblock'  =>
                    (new DocBlockGenerator())
            ->setShortDescription('Is a least one row exists with criteria')
            ->setLongDescription('')
            ->setTags([
                new ParamTag('criteria',['array'],'Criteria'),
                                new ReturnTag(['bool'],''),
...
BODY
                    ...
                    'docblock'  =>
                    (new DocBlockGenerator())
            ->setShortDescription('@see Laminas\Db\TableGateway\AbstractTableGateway::selectWith')
            ->setLongDescription('')
            ->setTags([
